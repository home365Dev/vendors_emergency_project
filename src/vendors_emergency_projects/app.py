...
def execute(data: dict):
    ...
    try:
        ...
        url = "https://app-prod.home365.co/projects-service-prod/projects/update-project?userId=495e020a-7af6-4381-a665-3c16d5ce4c1c"
        payload = req
        headers = {
        ...
        return result_to_dict, project_id_str, input_str
        ...
        return json_dict, project_id_str, input_str
